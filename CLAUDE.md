...
- Review every open issue in the repository
...
- Common triggers for new issues: a new entity added to `proto/` that needs a DB migration, a new event type that notifications must handle, a new proto field that the UI must surface
